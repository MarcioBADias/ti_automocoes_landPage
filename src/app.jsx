...
const App = () => {
  return (
    <main className="app">
      <About />
      <section style={{ background: 'var(--color-secondary)', padding:50 }} className='Products'>
    ...
    <section style={{ background: 'var(--color-light)', padding:50 }} className='Products'>
      <div className="prev_about" style={{ color: 'var(--color-primary)', textAlign: 'center', marginBottom: 20 }}>
